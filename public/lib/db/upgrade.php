...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2026030600.01) {
        ...
        $table->add_field('nextruntime', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null, 'classname');
        $table->add_field('nextstoptime', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null, 'nextstarttime');
        ...
        // Add scheduled adhoc tasks to the database table task_scheduled_adhoc.
