...
$string['editstaskscheduledadhoc'] = 'Edit scheduled ad hoc task: {$a}';
...
$string['scheduleddisabled'] = 'Disabled';
$string['scheduledadhoctasks'] = 'Scheduled ad hoc tasks';
$string['scheduleddisabled_help'] = 'Disabling an ad hoc task’s schedule will cause the task to execute as soon as possible.';
