...
use quiz_allocatedgrading\privacy\provider;
...
class provider_test extends \core_privacy\tests\provider_testcase {
    ...
    public function test_preference_bool_true(): void {
        ...
        set_user_preference('quiz_allocatedgrading_pagesize', 42);
        set_user_preference('quiz_allocatedgrading_order', 'random');
        ...
        $preferences = $writer->get_user_preferences('quiz_allocatedgrading');
    ...
    public function test_preference_bool_true_for_user_customfields(): void {
        ...
        foreach ($customfields as $customfield) {
            set_user_preference('quiz_allocatedgrading_order', $customfield);
