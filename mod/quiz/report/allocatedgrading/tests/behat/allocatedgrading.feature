@mod @mod_quiz @quiz @quiz_allocatedgrading
Feature: Basic use of the Allocated manual grading report
  In order to easily find students attempts that need manual grading
  As a teacher
  I need to use the allocated manual grading report
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | essay       | Essay 001        | Write aboute the capital city of France? |          | 100%  |
      | Test questions   | essay       | Essay 002        | Write aboute the capital city of Spain?  |          | 100%  |
    And the following "activities" exist:
      | activity | name     | course | idnumber   | groupmode | grouping |
      | quiz     | Quiz All | C1     | quizall    | 0         |          |
      | quiz     | Quiz 1   | C1     | quiz1      | 1         | tging    |
      | quiz     | Quiz 2   | C1     | quiz2      | 1         | tging    |
    And quiz "Quiz All" contains the following questions:
  ...
  Scenario: Allocated manual grading report without attempts
    When I am on the "Quiz 1" "mod_quiz > Allocated manual grading report" page logged in as "teacher1"
  ...
  Scenario: Allocated manual grading report with attempts
  ...
  Scenario: Allocated manual grading settings are remembered as user preferences
    Given user "student1" has attempted "Quiz 1" with responses:
      | slot | response |
      | 1    | Paris    |
    When I am on the "Quiz 1" "mod_quiz > Allocated manual grading report" page logged in as "teacher1"
    ...
    And I press "Change options"
    And I log out
    And I am on the "Quiz 1" "mod_quiz > Allocated manual grading report" page logged in as "teacher1"
    And I follow "Also show questions that have been graded automatically"
    And I click on "update grades" "link" in the "Short answer 001" "table_row"
  ...
  @javascript
  Scenario: Allocated manual grading settings are validated
    Given user "student1" has attempted "Quiz 1" with responses:
      | slot | response |
      | 1    | Paris    |
    And I am on the "Quiz 1" "mod_quiz > Allocated manual grading report" page logged in as "teacher1"
  ...
  Scenario: A marker cannot access the report in separate group
    ...
    And user "student2" has attempted "Quiz 1" with responses:
      | slot | response |
      | 1    | Duck     |
    When I am on the "Quiz 1" "mod_quiz > Allocated manual grading report" page logged in as "marker"
  ...
  @javascript
  Scenario: Allocated manual grading report with attempts to be graded
    ...
    And I press "Submit all and finish"
    And I click on "Submit all and finish" "button" in the "Submit all your answers and finish?" "dialogue"
    And I am on the "Quiz 2" "mod_quiz > Allocated manual grading report" page logged in as "teacher1"
    And I follow "Also show questions that have been graded automatically"
    ...
    #  As a teacher I should be able to assign specific manually questions im the quiz of my course to specific graders/markers.
    #  I should be able to organize which person will mark/grade which questions within moodle.
    #  As a grader (e.g. an assistant in the course) I should only see and grade the questions assigned to me by my superior (teacher).

  @javascript
  Scenario: Teacher can assign/un-assign graders.
    Given user "student1" has attempted "Quiz All" with responses:
      | slot | response |
      | 1    | Paris    |
    And I am on the "Quiz All" "mod_quiz > Allocated manual grading report" page logged in as "teacher1"
    And I click on "No grader assigned" "link" in the "Essay 001" "table_row"
    And I open the autocomplete suggestions list
    And I click on "S1 Student1" item in the autocomplete list
    And I click on "S2 Student2" item in the autocomplete list
    And I click on "Save changes" "link" in the "Essay 001" "table_row"
    And I reload the page
    And I should see "Student1" in the "Essay 001" "table_row"
    And I should see "Student2" in the "Essay 001" "table_row"
    And I click on "Student1" "link" in the "Essay 001" "table_row"
    And I click on "Student1" "autocomplete_selection" in the "Essay 001" "table_row"
    And I click on "Student2" "autocomplete_selection" in the "Essay 001" "table_row"
    And I click on "Save changes" "link" in the "Essay 001" "table_row"
    And I reload the page
    And I should see "No grader assigned" in the "Essay 001" "table_row"

  @javascript
  Scenario: Grader receives notification, and grades assigned question.
    Given user "student1" has attempted "Quiz All" with responses:
      | slot | response |
      | 1    | Paris    |
    And I am on the "Quiz All" "mod_quiz > Allocated manual grading report" page logged in as "teacher1"
    ...
    And I click on "You have been allocated to grade a quiz question(s): Quiz All" "link"
    And I click on "Quiz All" "link"
    And I should see "Essay 001"
    And I should not see "Essay 002"
    And I click on "Grade" "link" in the "Essay 001" "table_row"
    And I should see "Grading attempts 1 to 1 of 1"
    And I set the field "Comment" to "I have adjusted your mark to 0.6"
    And I set the field "Mark" to "0.6"
    And I press "Save and show next"
  ...
  @javascript
  Scenario: Non-grader can't access allocated grading report.
    Given user "student1" has attempted "Quiz 1" with responses:
      | slot | response |
      | 1    | Paris    |
    When I am on the "Quiz 1" "mod_quiz > Allocated manual grading report" page logged in as "student1"
    Then I should see "You do not have permission to manually grade responses in this quiz"

  @javascript
  Scenario: Teacher can assign/un-assign graders in only from grouping.
    Given user "student1" has attempted "Quiz 1" with responses:
      | slot | response |
      | 1    | Paris    |
    And I am on the "Quiz 1" "mod_quiz > Allocated manual grading report" page logged in as "teacher1"
    Then I should see "Separate groups (Tutor groups)"
    And I follow "Also show questions that have been graded automatically"
    And I click on "No grader assigned" "link" in the "Short answer 001" "table_row"
    And I open the autocomplete suggestions list
    And I should see "T1 Teacher1"
    And I should see "S1 Student1"
    And I should not see "M1 Marker1"
    And I should not see "S2 Student2"
    And I click on "S1 Student1" item in the autocomplete list
    And I click on "Save changes" "link" in the "Short answer 001" "table_row"
    And I reload the page
    And I should see "Student1" in the "Short answer 001" "table_row"
    And I click on "Student1" "link" in the "Short answer 001" "table_row"
    And I click on "Student1" "autocomplete_selection" in the "Short answer 001" "table_row"
    And I click on "Save changes" "link" in the "Short answer 001" "table_row"
    And I reload the page
    And I should see "No grader assigned" in the "Short answer 001" "table_row"
