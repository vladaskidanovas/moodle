...
$string['sectionsvisibility'] = 'Sections visibility';
$string['sectionsvisibility_help'] = 'Set course sections visibility by default. This setting determines whether sections are collapsed, expanded, or the first section is expanded and the rest collapsed.';
$string['sectionsvisibility:expandfirst'] = 'Expand first, collapse the rest';
